...
You will also need to install Docker Compose by doing:
"sudo pip install docker-compose".

Running the Containers
----------------------

Get the Unifield Linux AIO tar.gz file from the Unifield Support team.

Untar it.

From within the directory, run: "docker-compose up -d"

Docker will pull the images from the Docker Hub (approximately 400
